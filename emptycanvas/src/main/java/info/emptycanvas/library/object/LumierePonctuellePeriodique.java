...
public final class LumierePonctuellePeriodique implements Lumiere {
    ...
    public Color getCouleur(Color base, Point3D p, Point3D n) {
        ...
        return new Color((float) ((couleurObjet.getRed() / 256.0) * r + (couleurLumiere.getRed() / 256.0) * (1 - r)), (float) ((couleurObjet.getGreen() / 256.0) * r + (couleurLumiere.getGreen() / 256.0) * (1 - r)), (float) ((couleurObjet.getBlue() / 256.0) * r + (couleurLumiere.getBlue() / 256.0) * (1 - r)));
    }
